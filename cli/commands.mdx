...
- `/brief`: Initialise the conversation from your local memories. xCommand will proactively summarize your ongoing work or any relevant context found in your memory store.
