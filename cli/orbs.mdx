...
- **Custom Personas**: Each orb can be tailored with a specific persona, such as an "Oncall Engineer," "Security Auditor," or "Cost Optimizer."
...
- **Daemonization**: Starting an orb spawns a detached Bun process that persists even after you close your terminal.
